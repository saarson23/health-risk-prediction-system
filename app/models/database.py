...
class Prediction(db.Model):
    ...
    disease_type = db.Column(db.String(50), nullable=False)  # 'heart', 'diabetes', etc.
    ...
    explanation = db.Column(db.Text)  # JSON string of SHAP explanation
    created_at = db.Column(db.DateTime, default=datetime.utcnow)
...
class Alert(db.Model):
    ...
    alert_type = db.Column(db.String(20))  # 'email', 'sms'
